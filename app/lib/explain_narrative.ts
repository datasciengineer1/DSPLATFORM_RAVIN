...
export function expandStructToMarkdown(s: ExplainStruct, detail:"short"|"standard"|"deep"="deep"): string {
  ...
  return [
    ...
    s.what || "—", "",
    "### Drivers (why)", s.why || "—", "",
    "### KPI impact (structured)", kpiLines, "",
    "### How to analyze", bullets(s.how), "",
    "### Strategies / Mitigation", mitig, "",
    "### Assumptions & limits", bullets((s.assumptions||[]).concat(s.risks||[])), "",
    "### Next best steps", steps
  ].join("\n");
}
